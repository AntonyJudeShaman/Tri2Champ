          ...
          <div className=" col-11 col-sm-11">
            <a href="#nav1" onClick={scrollToTop}>
              <img
                src={logo}
                alt="Logo"
                className="h-22 mx-auto d-block pt-3"
              />
            </a>
            <p className="copy1 text-zinc-50 pt-4 pb-3">
            ...
            <div className="footer-links col-12 col-sm-11 pt-4 text-end">
              <a href={pdf1} className="hover:text-orange-500 pb-2">
                Cancellation and Refund Policy
              </a>
              <a href={pdf} className="hover:text-orange-500 pb-2">
            ...
            <p className="text-zinc-50 mx-auto d-block text-center pl-6 pt-4 pb-5">
      ...
      <div className="footer-container bg-gradient-to-b from-teal-900 to-zinc-950 border-t-2 bottom-0  border-indigo-300">
        ...
        <div className="footer-right text-end   col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
          ...
          <a href="tel:9677179907">
            <p className="text-end pb-2 hover:underline hover:text-orange-500">+91 9677179907</p>
          </a>
          <a href="https://www.google.com/maps/search/?api=1&query=13.0167188,80.1756658" className="hover:underline hover:text-orange-500">
            <p className="pb-4">
          ...
          <div className="footer-links ">
            <a href={pdf1} className="hover:text-orange-500 hover:underline pb-2">
              Cancellation and Refund Policy
            </a>
            <a href={pdf} className="hover:text-orange-500 hover:underline pb-2">
              Terms and Privacy Policy
            </a>
